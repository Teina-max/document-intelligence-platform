...
5. **Les rules `.claude/rules/`** (langue, credentials n8n, workflow
   lifecycle, interdictions d'actions prod) ont été essentielles pour
   que Claude Code livre en autonomie sans casser de prod.
